...
public interface Hangman {
  ...
  /**
   * Takes one character as guess. If the game is not initialized or is already ended an exception is thrown
   *
  ...
  /**
   * Get the masked phrase where the characters which are not already guessed are replaced with "_". If the phrase
   * contains whitespaces or punctuation characters then these are not masked.
   *
  ...
  /**
   * Get the solution phrase used for the initialisation of the game. When using this method the game is stopped.
   *
